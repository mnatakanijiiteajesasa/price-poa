...
class ExtractionRules:
    ...
    known_brands: List[str] = field(default_factory=lambda: [
        ...
        "eastmatt", "greenspoon", "zucchini", "dettol", "rosapharm", "savlon", "lifebuoy", "sunlight", "omo", "surf", "ariel", "persil", "airwick",
        ...
        "pringles", "doritos", "cheetos", "fritos", "tostitos", "hansa", "red bull"
        "britania", "manji", "trufoods", "cafenaivas", "supa loaf", "festive",

        # Meat / poultry
        "farmer's choice", "kenchic", "rina", "zuku foods", "tropical heat",
        "wamama", "kenafric", "kenmeat", 
        ...
        # Misc / catch-all
        "unilever", "nestle", "bic", "general meakins", "dairyland", "kasuku", "damsar", "dark & lovely", "afrisense", "farmers choice",
        "trust", "kiss", "rough rider", "duracell", "eveready", "highlands", "magnee", "softcare", "nipnap", "velvex", "cussons", "caresons"
    ])
    # Common categories
    known_categories: List[str] = field(default_factory=lambda: [
        # Staples
        "milk", "bread", "sugar", "maize flour", "wheat flour", "rice", "maize", "bacon", "energy drink", "sandwich", "snack", "doughnuts", "pizza", "burger", "chicken", "beef", "pork", "lamb", "turkey", "sausage", "bacon", "ham", "peanut butter", "beef kebab", "beef sausage",
        "unga", "salt", "pasta", "noodles", "cereals", "beans", "peas", "lentils", "masala", "spices", "herbs", "sauces", "condiments", "vinegar", "baking powder", "yeast", 
        "porridge flour", "baking flour", "cornflakes", "oats", "breakfast cereals", "cooking oil", "vegetable oil", "mandazi", "boerwors hot dogs", "chicken samosa", "chapati", 
        ...
        # Cleaning / household
        "soap", "detergent", "hand wash", "antiseptic", "bleach", "dish soap", "brightener", "foil"
        "air freshener", "insecticide", "toilet cleaner", "fabric softener", "cooker"

        # Cooking
        "oil", "fat", "cooking fat", "spices", "sauces", "condiments", "vinegar", "chicken", "green grams",
        "baking powder", "yeast", "spice", "soy sauce", "ketchup", "mustard", "mayonnaise", "chili sauce", "hot sauce",
        "butter", "margarine", "ghee", "cooking cream", "coconut milk", "stock cubes", "broth", "gravy", "soup",

        # Dairy / proteins / fresh
        "yoghurt", "icecream", "cheese", "butter", "cream", "eggs", "fish", "orange", "cashew nut butter", "beef samosa", "beaf smokies"
        "chicken", "beef", "pork", "lamb", "turkey", "sausage", "bacon", "ham", "peanut butter", "beef kebab", "beef sausage",
        "fruits", "vegetables", "cucumber", "tomato", "onion", "potato", "carrot", "spinach", "kale", "lettuce", "beef steak", "beef mince", "beef ribs", 
        "beef brisket", "beef liver", "beef tongue", "beef heart", "beef tripe", "beef oxtail", "beef shank", "beef chuck", "beef round", "beef sirloin", "beef tenderloin",
        ...
        "cotton wool", "shaving", "deodorant", "perfumes", "deodrant", "shampoo", "conditioner", "hair oil", "hair cream", "hair gel", "petroleum jelly", "baby soft & smooth powder"
        "body spray", "body lotion", "face cream", "face wash", "toothpaste", "toothbrush", "mouthwash", "perfume", "soap", "baby pants", "diapers", "baby wipes", "baby lotion", "baby powder", "baby oil", "baby shampoo", "baby soap", "sanitary pads", "condoms", "tissue paper", "toilet paper", "serviettes", "pads", "tampons", "sanitary napkins", "sanitary towels", "feminine hygiene products",
        ...
        "volleyball", "bag", "scouring powder", "towel", "tissue", "sticky notes", "books", "condom", "calculator", "short hand book", "a4", "w/machine", "m-wave" 
    ])
